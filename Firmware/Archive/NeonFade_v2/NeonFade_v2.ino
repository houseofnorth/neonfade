...
//  behaviour of NeonFade_Test and layers on:
...
void setup() {
  ...
  Serial.println();
  Serial.printf("=== NeonFade v2 Firmware v%d.%d.%d ===\n",
  ...
  if (!calibDone()) {
    Serial.println("Motor is DISABLED until calibration is saved. Type C to start.");
  }
}
